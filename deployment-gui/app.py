...
interface = gr.Interface(
    ...
    inputs=[
        ...
        gr.inputs.Dropdown(label="Quantization", choices=quantization_types, default="None"),
        gr.inputs.Slider(label="Context Length", min_value=10, max_value=1000, step=1, default=512),
    ],
